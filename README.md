...
Send the link ([github.com/DTA-Projects/opencode-kali](https://github.com/DTA-Projects/opencode-kali)) to a friend and they can set up their own lab in one command.
